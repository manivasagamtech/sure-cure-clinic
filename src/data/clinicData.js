...
export const navGroups = [
  ...
  },
  {
    ...
    href: "#services",
    items: [
      { label: "Chronic pain syndrome", href: "#services" },
      { label: "Disc problems and sciatica", href: "#services" },
      { label: "Headaches and migraine", href: "#services" },
      { label: "Arthritis and frozen shoulder", href: "#services" },
    ],
  },
  {
    label: "Services",
    href: "#services",
    items: [
      { label: "Dry needling", href: "#services" },
      { label: "Regeneration therapy", href: "#services" },
      { label: "Manual therapy", href: "#services" },
      { label: "Sports taping", href: "#services" },
